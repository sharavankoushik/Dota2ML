...
def main():
    ...
    start_match_id = None
    while True:
        # Note: GetMatchHistory returns a list of matches in descending order,going back in time.
        sleep(1.0)
        ...
        for match in matches:
            ...
            if match_collection.find({'match_id': match_id}) != None:
        ...
        # Don't want to record the last match twice, so subtract 1
